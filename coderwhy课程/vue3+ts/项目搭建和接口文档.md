...
[*.md] # 表示仅 md 文件适用以下规则
max_line_length = off  #限制每行的最大文本
trim_trailing_whitespace = false # 去除行尾的任意空白字符
```
...
![image-20240318093624947](img/image-20240318093624947.png)

![image-20240318093920603](img/image-20240318093920603.png)
...
![image-20240318094418830](img/image-20240318094418830.png)

* useTabs：使用tab缩进还是空格缩进，选择false；
* tabWidth：tab是空格的情况下，是几个空格，选择2个；
* printWidth：当行字符的最长长度，推荐80，也有人喜欢100或者120；
...
3.创建.prettierignore忽略文件 (不需要格式化的文件)

![image-20240318200739361](img/image-20240318200739361.png)
...
![image-20240318094755685](img/image-20240318094755685.png)



5.VSCod中的配置

![image-20240318095018190](img/image-20240318095018190.png)

- settings =>format on save => 勾选上
- settings => editor default format => 选择 prettier
- ![image-20240318095721569](img/image-20240318095721569.png)
...
![image-20240318152206893](img/image-20240318152206893.png)

3.解决eslint和prettier冲突的问题：

安装插件：（vue在创建项目时，如果选择prettier，那么这两个插件会自动安装）

eslint-config-prettier如果选择prettier会自动安装(或vue自带 不用安装)
...
![image-20240318152421961](img/image-20240318152421961.png)
...
```json
  extends: [
    ...
    'plugin:prettier/recommended'//添加的
  ],
```
...
![image-20240318200201587](img/image-20240318200201587.png)
